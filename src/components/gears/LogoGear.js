...
const LogoGear = ({ refFunc, additionalStyles }) => (
  <svg
    ...
    width="20mm"
    height="20mm"
    viewBox="231 120 100 110"
  >
    <filter id="logo2" height="2" width="2">
      <feTurbulence baseFrequency="4.1" numOctaves="10" type="fractalNoise" />
      <feDisplacementMap scale="2.1" xChannelSelector="R" in="SourceGraphic" />
    </filter>
    <g filter="url(#logo2)">
...
export default Radium(LogoGear);
